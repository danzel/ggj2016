...
class Ui {
	...
	constructor(private gameArg: Phaser.Game, private playersArg: Array<Player>) {
		...
		const barWidth = 230;
		this.p1Mana = new HealthBar(this.graphics, barWidth, 22, 3, 0x191060, 0x442BFF, false, 50, 20);
		this.p1Health = new HealthBar(this.graphics, barWidth, 22, 3, 0x60120B, 0xE52C1B, false, 50, 55);
		this.p2Mana = new HealthBar(this.graphics, barWidth, 22, 3, 0x191060, 0x442BFF, true, 1280 - 50 - barWidth, 20);
		this.p2Health = new HealthBar(this.graphics, barWidth, 22, 3, 0x60120B, 0xE52C1B, true, 1280 - 50 - barWidth, 55);
	}
